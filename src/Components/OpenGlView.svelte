...
<script>
  ...
  import { squarePositions, squareColors } from "./squareDatas.js";
  import {
    cubePositions,
    CubeFaceColors,
  ...
  function initBuffers(gl) {
    ...
    for (var j = 0; j < CubeFaceColors.length; ++j) {
      const c = CubeFaceColors[j];
  ...
  function drawScene(gl, programInfo, buffers, texture, deltaTime) {
    gl.clearColor(0.373, 0.62, 0.627, 1.0); // Clear to black, fully opaque
